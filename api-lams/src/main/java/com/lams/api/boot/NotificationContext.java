...
public class NotificationContext implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent arg0) {
		NotificationProvider notificationProvider = notificationProviderRepository
		...
		int port = Integer.parseInt(
				environment.getRequiredProperty(notificationProvider.getProperty() + "." + PROPERTY_NAME_EMAIL_PORT));
		javaMailSender.setHost(
				environment.getRequiredProperty(notificationProvider.getProperty() + "." + PROPERTY_NAME_EMAIL_HOST));
		javaMailSender.setPassword(environment
				.getRequiredProperty(notificationProvider.getProperty() + "." + PROPERTY_NAME_EMAIL_PASSWORD));
		javaMailSender.setPort(port);
		javaMailSender.setProtocol(environment
				.getRequiredProperty(notificationProvider.getProperty() + "." + PROPERTY_NAME_EMAIL_PROTOCOL));
		javaMailSender.setUsername(environment
				.getRequiredProperty(notificationProvider.getProperty() + "." + PROPERTY_NAME_EMAIL_USERNAME));
		Properties properties = new Properties();

		properties.setProperty(PROPERTY_NAME_EMAIL_SMTP_AUTH, environment
				.getRequiredProperty(notificationProvider.getProperty() + "." + PROPERTY_NAME_EMAIL_SMTP_AUTH));
		properties.setProperty(PROPERTY_NAME_EMAIL_SMTP_STARTTLS, environment
				.getRequiredProperty(notificationProvider.getProperty() + "." + PROPERTY_NAME_EMAIL_SMTP_STARTTLS));
		...
		NotificationProvider notificationProviderSMS = notificationProviderRepository
				.findByNotificationTypeAndIsActive(NotificationType.SMS.getValue(), true);

		System.out.println(environment
				.getRequiredProperty(notificationProviderSMS.getProperty() + "." + PROPERTY_NAME_SMS_USERNAME));
		smsProperty = new SMSProperty();
		smsProperty.setUsername(environment
				.getRequiredProperty(notificationProviderSMS.getProperty() + "." + PROPERTY_NAME_SMS_USERNAME));
		smsProperty.setPassword(environment
				.getRequiredProperty(notificationProviderSMS.getProperty() + "." + PROPERTY_NAME_SMS_PASSWORD));
		smsProperty.setOriginator(environment
				.getRequiredProperty(notificationProviderSMS.getProperty() + "." + PROPERTY_NAME_SMS_ORIGINATOR));
		smsProperty.setRequestURL(environment
				.getRequiredProperty(notificationProviderSMS.getProperty() + "." + PROPERTY_NAME_SMS_REQUESTURL));
